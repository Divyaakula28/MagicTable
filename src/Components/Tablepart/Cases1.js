 ...
 export const Cases1=(Pro)=>{
    ...
    const colorlooping=(ind,lst,lst1,lst2)=>{
        if ((~[10,11,2,3,4,5,6,7,8,9].indexOf(diffcases))<0){
    ...
    const selectcolor=(ind)=>{
        ...
        if (diffcases===4){return(colorlooping(ind,[1,4,13,16]))   }
        if (diffcases===5){return(colorlooping(ind,[6,7,10,11]))}
        if (diffcases===8){return(colorlooping(ind,[1,2,5,6]))}
        if (diffcases===9){return(colorlooping(ind,[3,4,7,8]))}
        if (diffcases===10){return(colorlooping(ind,[9,10,13,14]))}
        if (diffcases===11){return(colorlooping(ind,[11,12,15,16]))}
        if (diffcases===6){return(colorlooping(ind,[2,3,14,15]))}
        if (diffcases===7){return(colorlooping(ind,[5,9,8,12]))}
        if (diffcases===2){return(colorlooping(ind,[4,7,10,13]))}
        if (diffcases===3){return(colorlooping(ind,[1,6,11,16]))}
